...
// Para `restaurar`: POLAR_PRODUCT_ID_PRO_ANUAL y POLAR_PRODUCT_ID_SIN_PROMOS.
...
async function main() {
  ...
  if (!['crear-test', 'restaurar'].includes(modo)) throw new Error('uso: polar-precios.js <crear-test|restaurar> [--apply]');
